...
@Slf4j
@Service
public class ChargeSessionMessageService extends AbstractMessageService<ChargeSessionMessage> {
    ...
    @Override
    public void sendMessage(ChargeSessionMessage chargeSessionMessage, String topic, boolean retain) {
        log.info("Publish session event to {}", topic);
        String payload = toJson(chargeSessionMessage);
